...
# Charger .env avec l'encodage UTF-8 (pour éviter les erreurs d'encodage)
load_dotenv(encoding='utf-8')

BASE_DIR = Path(__file__).resolve().parent.parent

SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-186u2zg9zi2s!7=0_nmr8^)0y^w8w6dep12jpxveet3g(ck#-o')
